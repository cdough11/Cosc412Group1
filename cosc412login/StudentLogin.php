...
$query = "SELECT EmailAddress FROM Student WHERE EmailAddress = '" . $emailAddress . "' AND Password = '" . $sitePassword . "';";
...
if($stmt = mysqli_prepare($conn, $query)){
	...
	if($foundMatch == null)
		$foundMatch = "NULL";
	if($foundMatch){
		$url = "https://edufit.000webhostapp.com/student-interface.html";
		header("Location: " . $url);
		die();
	}
	else{
